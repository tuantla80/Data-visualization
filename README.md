...
- Step 1. Getting and configure it to display math equation inline with text or in a new line. (http://docs.mathjax.org/en/latest/configuration.html)
    ``` <script src='https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5/latest.js?config=TeX-MML-AM_CHTML' async></script> ``` </br>
   ...
   ``` </br>
   ``` <script type="text/javascript" src="path-to-MathJax/MathJax.js"> </script> ``` </br>
